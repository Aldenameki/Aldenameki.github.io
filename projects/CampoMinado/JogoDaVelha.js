...
class Game {    //A engine do jogo
    ...
    constructor(canvasId, scoreId, rows=10, cols=10) {
        ...
        //this.score = this.table.getElementsByTagName('td')[0];
    ...
    set(rows, cols) {   //Configura o jogo
        this.rows = rows;
        this.cols = cols;
        this.xSSize = this.canvas.width / this.cols;
        this.ySSize = this.canvas.height / this.rows;
    ...
    youWin() {
        ...
        this.drawText(5,10, 'Você ganhou!', '50', 'Arial', '#00ff00');
    }
    ...
    clearScreen() { //Limpa a tela (canvas)
        this.c.clearRect(0, 0, this.canvas.widt, this.canvas.height);
    }
